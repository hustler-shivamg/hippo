...
class MyConfig {
  /// APP CONFIG
  static final String APP_NAME = "Hippo";
  static final String BASE_URL = "https://projects.creative-hustlers.in/hippo/";
  //static final String BASE_URL = "http://192.168.0.102:8000/";
  ...
  static final String USER_LOCATION_LATITUDE = 'USER_LOCATION_LATITUDE';
  static final String USER_LOCATION_LONGITUDE = 'USER_LOCATION_LONGITUDE';
...
class CategoryType {
  static final int CAREGIVERS = 1;
  static final int KINDERGARDENS = 2;
  static final int DRIVERS = 3;
  static final int PEDIATRICIANS = 4;
  static final int ENTERTAINMENT = 5;

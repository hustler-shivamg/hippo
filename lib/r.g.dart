...
class _R_Image_AssetResource {
  ...
  /// asset: assets/images/dashboard_logo.png
  // ignore: non_constant_identifier_names
  final dashboard_logo = const AssetResource("assets/images/dashboard_logo.png",
      packageName: null);

  /// asset: assets/images/ic_kindergardan.png
  // ignore: non_constant_identifier_names
  final ic_kindergardan = const AssetResource(
      "assets/images/ic_kindergardan.png",
      packageName: null);

  /// asset: assets/images/ic_pediatricians.png
  // ignore: non_constant_identifier_names
  final ic_pediatricians = const AssetResource(
      "assets/images/ic_pediatricians.png",
      packageName: null);
}
...
class _R_Svg_AssetResource {
  ...
  /// asset: assets/images/dashboard_bg.svg
  // ignore: non_constant_identifier_names
  final dashboard_bg =
      const AssetResource("assets/images/dashboard_bg.svg", packageName: null);

  /// asset: assets/images/ic_caregiver.svg
  // ignore: non_constant_identifier_names
  final ic_caregiver =
      const AssetResource("assets/images/ic_caregiver.svg", packageName: null);
}
...
class _R_Image {
  ...
  /// asset: assets/images/dashboard_logo.png
  // ignore: non_constant_identifier_names
  AssetImage dashboard_logo() {
    return AssetImage(asset.dashboard_logo.keyName);
  }

  /// asset: assets/images/ic_kindergardan.png
  // ignore: non_constant_identifier_names
  AssetImage ic_kindergardan() {
    return AssetImage(asset.ic_kindergardan.keyName);
  }

  /// asset: assets/images/ic_pediatricians.png
  // ignore: non_constant_identifier_names
  AssetImage ic_pediatricians() {
    return AssetImage(asset.ic_pediatricians.keyName);
  }
}
...
class _R_Svg {
  ...
  /// asset: assets/images/dashboard_bg.svg
  // ignore: non_constant_identifier_names
  AssetSvg dashboard_bg({required double width, required double height}) {
    final imageProvider =
        AssetSvg(asset.dashboard_bg.keyName, width: width, height: height);
    return imageProvider;
  }

  /// asset: assets/images/ic_caregiver.svg
  // ignore: non_constant_identifier_names
  AssetSvg ic_caregiver({required double width, required double height}) {
    final imageProvider =
        AssetSvg(asset.ic_caregiver.keyName, width: width, height: height);
    return imageProvider;
  }
}

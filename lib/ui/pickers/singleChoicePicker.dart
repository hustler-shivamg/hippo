...
class SingleChoicePicker extends StatefulWidget {
  final String? title;
  ...
  @override
  _SingleChoicePickerState createState() => _SingleChoicePickerState();
}

DropdownValues? selectedList;

class _SingleChoicePickerState extends State<SingleChoicePicker> {
              ...
              Row(
                children: [
                  FlutterSwitch(
                    ...
                    height: 34.h,
                    toggleSize: 34.r,
                    value: selectedList != null && selectedList == dataValue,
                    borderRadius: 30.r,
                    padding: 1.r,
